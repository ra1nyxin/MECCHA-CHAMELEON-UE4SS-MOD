...
{
    TArray<class UMovieSceneSection*> ConstraintSections;                             // 0x0110 (size: 0x10)
...
class UMovieSceneAudioSection : public UMovieSceneSection
{
    ...
    TMap<class FName, class FMovieSceneFloatChannel> Inputs_Float;                    // 0x0358 (size: 0x50)
    TMap<class FName, class FMovieSceneStringChannel> Inputs_String;                  // 0x03A8 (size: 0x50)
    TMap<class FName, class FMovieSceneBoolChannel> Inputs_Bool;                      // 0x03F8 (size: 0x50)
    TMap<class FName, class FMovieSceneIntegerChannel> Inputs_Int;                    // 0x0448 (size: 0x50)
    TMap<class FName, class FMovieSceneAudioTriggerChannel> Inputs_Trigger;           // 0x0498 (size: 0x50)
...
{
    TArray<class UMovieSceneSection*> AudioSections;                                  // 0x0110 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> CameraShakeSections;                            // 0x0110 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0120 (size: 0x10)
...
{
    TArray<class UDataLayerAsset*> DataLayerAssets;                                   // 0x0110 (size: 0x10)
...
class UMovieSceneEventTrack : public UMovieSceneNameableTrack
{
    ...
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0128 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> ParticleSections;                               // 0x0118 (size: 0x10)
...
class UMovieScenePropertyTrack : public UMovieSceneNameableTrack
{
    ...
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0130 (size: 0x10)
