...
struct FNDCIsland
{
    ...
    TArray<class UNiagaraComponent*> SpawnedComponents;                               // 0x0040 (size: 0x10)
...
struct FNiagaraComponentPropertyBinding
{
    ...
    TMap<class FString, class FString> PropertySetterParameterDefaults;               // 0x0060 (size: 0x50)
...
struct FNiagaraScriptAsyncCompileData
{
    ...
    TMap<class FName, class UNiagaraDataInterface*> NamedDataInterfaces;              // 0x0090 (size: 0x50)
...
class UNiagaraDataInterfaceArrayMesh : public UNiagaraDataInterfaceArray
{
    ...
    void SetNiagaraArrayMeshSM(class UNiagaraComponent* NiagaraComponent, FName OverrideName, const TArray<class UStaticMesh*>& ArrayData);
...
class UNiagaraScript : public UNiagaraScriptBase
{
    ...
    TArray<class UNiagaraParameterCollection*> CachedParameterCollectionReferences;   // 0x0348 (size: 0x10)
...
class UNiagaraStatelessEmitter : public UObject
{
    ...
    TArray<class UNiagaraStatelessModule*> Modules;                                   // 0x0138 (size: 0x10)
    TArray<class UNiagaraRendererProperties*> RendererProperties;                     // 0x0148 (size: 0x10)
    ...
    TArray<class UNiagaraParameterCollection*> CachedParameterCollectionReferences;   // 0x01F0 (size: 0x10)
