...
struct FCompactStateTransition
{
    ...
    FStateTreeDelegateDispatcher RequiredDelegateDispatcher;                          // 0x0010 (size: 0x10)
    uint16 ConditionsBegin;                                                           // 0x0020 (size: 0x2)
    FStateTreeStateHandle State;                                                      // 0x0022 (size: 0x2)
    FStateTreeRandomTimeDuration Delay;                                               // 0x0024 (size: 0x4)
    EStateTreeTransitionTrigger Trigger;                                              // 0x0028 (size: 0x1)
    EStateTreeTransitionPriority Priority;                                            // 0x0029 (size: 0x1)
    EStateTreeSelectionFallback Fallback;                                             // 0x002A (size: 0x1)
    uint8 ConditionsNum;                                                              // 0x002B (size: 0x1)
    uint8 bTransitionEnabled;                                                         // 0x002C (size: 0x1)
    uint8 bConsumeEventOnSelect;                                                      // 0x002C (size: 0x1)

}; // Size: 0x30

struct FCompactStateTreeFrame
{
    FStateTreeStateHandle RootState;                                                  // 0x0000 (size: 0x2)
    uint8 NumberOfTasksStatusMasks;                                                   // 0x0002 (size: 0x1)
...
struct FCompactStateTreeState
{
    ...
    float CustomTickRate;                                                             // 0x0048 (size: 0x4)
    uint32 CompletionTasksMask;                                                       // 0x004C (size: 0x4)
    uint8 CompletionTasksMaskBufferIndex;                                             // 0x0050 (size: 0x1)
    uint8 CompletionTasksMaskBitsOffset;                                              // 0x0051 (size: 0x1)
    EStateTreeTaskCompletionType CompletionTasksControl;                              // 0x0052 (size: 0x1)
    uint8 EnterConditionsNum;                                                         // 0x0053 (size: 0x1)
    uint8 UtilityConsiderationsNum;                                                   // 0x0054 (size: 0x1)
    uint8 TransitionsNum;                                                             // 0x0055 (size: 0x1)
    uint8 TasksNum;                                                                   // 0x0056 (size: 0x1)
    uint8 EnabledTasksNum;                                                            // 0x0057 (size: 0x1)
    uint8 InstanceDataNum;                                                            // 0x0058 (size: 0x1)
    uint8 Depth;                                                                      // 0x0059 (size: 0x1)
    EStateTreeStateType Type;                                                         // 0x005A (size: 0x1)
    EStateTreeStateSelectionBehavior SelectionBehavior;                               // 0x005B (size: 0x1)
    uint8 bHasTransitionTasks;                                                        // 0x005C (size: 0x1)
    uint8 bHasStateChangeConditions;                                                  // 0x005C (size: 0x1)
    uint8 bHasTickTriggerTransitions;                                                 // 0x005C (size: 0x1)
    uint8 bHasEventTriggerTransitions;                                                // 0x005C (size: 0x1)
    uint8 bHasDelegateTriggerTransitions;                                             // 0x005D (size: 0x1)
    uint8 bHasCompletedTriggerTransitions;                                            // 0x005D (size: 0x1)
    uint8 bHasSucceededTriggerTransitions;                                            // 0x005D (size: 0x1)
    uint8 bHasFailedTriggerTransitions;                                               // 0x005D (size: 0x1)
    uint8 bCheckPrerequisitesWhenActivatingChildDirectly;                             // 0x005D (size: 0x1)
    uint8 bEnabled;                                                                   // 0x005D (size: 0x1)
    uint8 bConsumeEventOnSelect;                                                      // 0x005D (size: 0x1)
    uint8 bHasCustomTickRate;                                                         // 0x005D (size: 0x1)
...
struct FRecordedStateTreeExecutionFrame
{
    ...
    FStateTreeActiveStates ActiveStates;                                              // 0x000C (size: 0x34)
    uint8 bIsGlobalFrame;                                                             // 0x0040 (size: 0x1)
...
{
    FStateTreeStateHandle States;                                                     // 0x0020 (size: 0x10)
    uint8 NumStates;                                                                  // 0x0030 (size: 0x1)
...
{
    FStateTreeDataHandle DataHandle;                                                  // 0x0018 (size: 0x6)
    EStateTreeBindableStructSource DataSource;                                        // 0x001E (size: 0x1)
...
struct FStateTreeBlueprintTaskWrapper : public FStateTreeTaskBase
{
    ...
    uint8 TaskFlags;                                                                  // 0x0030 (size: 0x1)
...
struct FStateTreeDebugTextTaskInstanceData
{
    ...
    FString BindableText;                                                             // 0x0008 (size: 0x10)
...
{
    FStateTreeDelegateDispatcher Dispatcher;                                          // 0x0000 (size: 0x10)
...
struct FStateTreeExecutionFrame
{
    ...
    FStateTreeStateHandle RootState;                                                  // 0x0008 (size: 0x2)
    FStateTreeActiveStates ActiveStates;                                              // 0x000C (size: 0x34)
    FStateTreeTasksCompletionStatus ActiveTasksStatus;                                // 0x0040 (size: 0x10)
    FStateTreeIndex16 ExternalDataBaseIndex;                                          // 0x0054 (size: 0x2)
    FStateTreeIndex16 GlobalInstanceIndexBase;                                        // 0x0056 (size: 0x2)
    FStateTreeIndex16 ActiveInstanceIndexBase;                                        // 0x0058 (size: 0x2)
    FStateTreeDataHandle StateParameterDataHandle;                                    // 0x005A (size: 0x6)
    FStateTreeDataHandle GlobalParameterDataHandle;                                   // 0x0060 (size: 0x6)
    uint8 bIsGlobalFrame;                                                             // 0x0067 (size: 0x1)
...
struct FStateTreeExecutionState
{
    ...
    FRandomStream RandomStream;                                                       // 0x0020 (size: 0x8)
    FInstancedStruct ExecutionExtension;                                              // 0x0058 (size: 0x10)
    FStateTreeIndex16 EnterStateFailedFrameIndex;                                     // 0x0068 (size: 0x2)
    FStateTreeIndex16 EnterStateFailedTaskIndex;                                      // 0x006A (size: 0x2)
    FStateTreeIndex16 LastExitedNodeIndex;                                            // 0x006C (size: 0x2)
    EStateTreeRunStatus LastTickStatus;                                               // 0x006E (size: 0x1)
    EStateTreeRunStatus TreeRunStatus;                                                // 0x006F (size: 0x1)
    EStateTreeRunStatus RequestedStop;                                                // 0x0070 (size: 0x1)
    EStateTreeUpdatePhase CurrentPhase;                                               // 0x0071 (size: 0x1)
    uint16 StateChangeCount;                                                          // 0x0072 (size: 0x2)
    bool bHasPendingCompletedState;                                                   // 0x0074 (size: 0x1)
...
struct FStateTreeInstanceStorage
{
    ...
    FStateTreeExecutionState ExecutionState;                                          // 0x0010 (size: 0x78)
    TArray<FStateTreeTemporaryInstanceData> TemporaryInstances;                       // 0x0088 (size: 0x10)
    TArray<FStateTreeTransitionRequest> TransitionRequests;                           // 0x00B8 (size: 0x10)
    FInstancedPropertyBag GlobalParameters;                                           // 0x00C8 (size: 0x10)
    uint32 UniqueIdGenerator;                                                         // 0x00D8 (size: 0x4)
...
{
    TArray<FStateTreeBindableStructDesc> SourceStructs;                               // 0x00C0 (size: 0x10)
    TArray<FStateTreePropertyPathBinding> PropertyPathBindings;                       // 0x00D0 (size: 0x10)
    TArray<FStateTreePropertyRefPath> PropertyReferencePaths;                         // 0x00E0 (size: 0x10)
    TArray<FStateTreePropertyAccess> PropertyAccesses;                                // 0x00F0 (size: 0x10)
...
{
    FPropertyBindingPath SourcePropertyPath;                                          // 0x0000 (size: 0x10)
...
{
    float NextDeltaTime;                                                              // 0x0000 (size: 0x4)
...
struct FStateTreeStateLink
{
    ...
    EStateTreeSelectionFallback Fallback;                                             // 0x0002 (size: 0x1)
...
{
    FStateTreeDataHandle DataHandle;                                                  // 0x0004 (size: 0x6)
    FStateTreeIndex16 OwnerNodeIndex;                                                 // 0x000A (size: 0x2)
    FInstancedStruct Instance;                                                        // 0x0010 (size: 0x10)

}; // Size: 0x20

struct FStateTreeTransitionDelayedState
{
    class UStateTree* StateTree;                                                      // 0x0008 (size: 0x8)
    FStateTreeSharedEvent CapturedEvent;                                              // 0x0010 (size: 0x10)
    float TimeLeft;                                                                   // 0x0020 (size: 0x4)
    uint32 CapturedEventHash;                                                         // 0x0024 (size: 0x4)
    FStateTreeStateHandle StateHandle;                                                // 0x0028 (size: 0x2)
    FStateTreeIndex16 TransitionIndex;                                                // 0x002A (size: 0x2)
...
{
    FStateTreeStateHandle TargetState;                                                // 0x0000 (size: 0x2)
    EStateTreeTransitionPriority Priority;                                            // 0x0002 (size: 0x1)
    EStateTreeSelectionFallback Fallback;                                             // 0x0003 (size: 0x1)
...
struct FStateTreeTransitionResult
{
    ...
    FStateTreeStateHandle SourceState;                                                // 0x0028 (size: 0x2)
    FStateTreeStateHandle TargetState;                                                // 0x002A (size: 0x2)
    FStateTreeStateHandle CurrentState;                                               // 0x002C (size: 0x2)
    EStateTreeRunStatus CurrentRunStatus;                                             // 0x002E (size: 0x1)
    EStateTreeStateChangeType ChangeType;                                             // 0x002F (size: 0x1)
    EStateTreeTransitionPriority Priority;                                            // 0x0030 (size: 0x1)
    class UStateTree* SourceStateTree;                                                // 0x0038 (size: 0x8)
    FStateTreeStateHandle SourceRootState;                                            // 0x0040 (size: 0x2)
...
class UStateTree : public UDataAsset
{
    ...
    TArray<FCompactStateTreeFrame> Frames;                                            // 0x0040 (size: 0x10)
    TArray<FCompactStateTreeState> States;                                            // 0x0050 (size: 0x10)
    TArray<FCompactStateTransition> Transitions;                                      // 0x0060 (size: 0x10)
    FInstancedStructContainer Nodes;                                                  // 0x0070 (size: 0x10)
    FStateTreeInstanceData DefaultInstanceData;                                       // 0x0080 (size: 0x10)
    FStateTreeInstanceData SharedInstanceData;                                        // 0x0090 (size: 0x10)
    TArray<FStateTreeExternalDataDesc> ContextDataDescs;                              // 0x00B8 (size: 0x10)
    FStateTreePropertyBindings PropertyBindings;                                      // 0x00D0 (size: 0x100)
    TArray<FStateTreeStateIdToHandle> IDToStateMappings;                              // 0x01D0 (size: 0x10)
    TArray<FStateTreeNodeIdToIndex> IDToNodeMappings;                                 // 0x01E0 (size: 0x10)
    TArray<FStateTreeTransitionIdToIndex> IDToTransitionMappings;                     // 0x01F0 (size: 0x10)
    FInstancedPropertyBag Parameters;                                                 // 0x0200 (size: 0x10)
    TArray<FStateTreeExternalDataDesc> ExternalDataDescs;                             // 0x0210 (size: 0x10)
    uint32 CompletionGlobalTasksMask;                                                 // 0x0220 (size: 0x4)
    uint16 NumContextData;                                                            // 0x0224 (size: 0x2)
    uint16 NumGlobalInstanceData;                                                     // 0x0226 (size: 0x2)
    uint16 EvaluatorsBegin;                                                           // 0x0228 (size: 0x2)
    uint16 EvaluatorsNum;                                                             // 0x022A (size: 0x2)
    uint16 GlobalTasksBegin;                                                          // 0x022C (size: 0x2)
    uint16 GlobalTasksNum;                                                            // 0x022E (size: 0x2)
    EStateTreeTaskCompletionType CompletionGlobalTasksControl;                        // 0x0230 (size: 0x1)
    EStateTreeParameterDataType ParameterDataType;                                    // 0x0231 (size: 0x1)
    uint8 bHasGlobalTransitionTasks;                                                  // 0x0232 (size: 0x1)
...
class UStateTreeFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    void SetStateTree(FStateTreeReference& Reference, class UStateTree* StateTree);
    FStateTreeReference MakeStateTreeReference(class UStateTree* StateTree);
    void K2_SetParametersProperty(FStateTreeReference& Reference, FGuid PropertyID, const int32& NewValue);
    void K2_GetParametersProperty(const FStateTreeReference& Reference, FGuid PropertyID, int32& ReturnValue);
}; // Size: 0x28
...
class UStateTreeNodeBlueprintBase : public UObject
{
    ...
    FText ReceiveGetDescription(EStateTreeNodeFormatting Formatting);
...
{
    uint8 bShouldStateChangeOnReselect;                                               // 0x0059 (size: 0x1)
    uint8 bShouldCallTickOnlyOnEvents;                                                // 0x0059 (size: 0x1)
    uint8 bShouldCopyBoundPropertiesOnTick;                                           // 0x0059 (size: 0x1)
    uint8 bShouldCopyBoundPropertiesOnExitState;                                      // 0x0059 (size: 0x1)
    ...
    void BroadcastDelegate(FStateTreeDelegateDispatcher Dispatcher);
    void BindDelegate(const FStateTreeDelegateListener& Listener, const FBindDelegateDelegate& Delegate);
}; // Size: 0x60
