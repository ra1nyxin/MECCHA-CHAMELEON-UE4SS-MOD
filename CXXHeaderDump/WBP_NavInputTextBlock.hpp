#ifndef UE4SS_SDK_WBP_NavInputTextBlock_HPP
#define UE4SS_SDK_WBP_NavInputTextBlock_HPP

class UWBP_NavInputTextBlock_C : public UUINavComponent
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0910 (size: 0x8)
    class UTextBlock* RemainText;                                                     // 0x0918 (size: 0x8)
    class UEditableText* EditableText;                                                // 0x0920 (size: 0x8)
    FText HintText;                                                                   // 0x0928 (size: 0x10)
    bool PasswordMode;                                                                // 0x0938 (size: 0x1)
    FWBP_NavInputTextBlock_COnTextCommitted OnTextCommitted;                          // 0x0940 (size: 0x10)
