...
{
    FLiveLinkSubjectName SubjectName;                                                 // 0x00B8 (size: 0x8)
    FName ActorTransformBone;                                                         // 0x00C0 (size: 0x8)
    bool bModifyActorTransform;                                                       // 0x00C8 (size: 0x1)
    bool bSetRelativeLocation;                                                        // 0x00C9 (size: 0x1)
...
{
    TArray<FLiveLinkVirtualSubjectBoneAttachment> Attachments;                        // 0x0180 (size: 0x10)
    EBoneTransformResolution LocationBehavior;                                        // 0x0190 (size: 0x4)
    EBoneTransformResolution RotationBehavior;                                        // 0x0194 (size: 0x4)
    bool bAppendSubjectNameToBones;                                                   // 0x0198 (size: 0x1)
...
class ULiveLinkBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    void UnpauseSubject(const FLiveLinkSubjectName SubjectName);
    ...
    void PauseSubject(const FLiveLinkSubjectName SubjectName);
...
{
    FLiveLinkComponentOnLiveLinkUpdated OnLiveLinkUpdated;                            // 0x00B8 (size: 0x10)
...
{
    FString SubjectName;                                                              // 0x00A0 (size: 0x10)
    FString OutboundName;                                                             // 0x00B0 (size: 0x10)
    FString Source;                                                                   // 0x00C0 (size: 0x10)
    class ULiveLinkFrameTranslator* TranslatorsProxy;                                 // 0x00D0 (size: 0x8)

}; // Size: 0xE0

class ULiveLinkLocatorAxisSwitchPreProcessor : public ULiveLinkTransformAxisSwitchPreProcessor
{
}; // Size: 0x70
...
class ULiveLinkSettings : public UObject
{
    ...
    bool bTransmitEvaluatedData;                                                      // 0x00B2 (size: 0x1)
