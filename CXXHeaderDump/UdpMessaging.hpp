...
class UUdpMessagingSettings : public UObject
{
    ...
    uint32 MaxConcurrentDeserializationTasks;                                         // 0x0084 (size: 0x4)
    bool EnableTunnel;                                                                // 0x0088 (size: 0x1)
    FString TunnelUnicastEndpoint;                                                    // 0x0090 (size: 0x10)
    FString TunnelMulticastEndpoint;                                                  // 0x00A0 (size: 0x10)
    TArray<FString> RemoteTunnelEndpoints;                                            // 0x00B0 (size: 0x10)
