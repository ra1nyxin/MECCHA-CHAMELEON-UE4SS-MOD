enum class EDataflowImageChannel {
    Red = 0,
    Green = 1,
    Blue = 2,
    Alpha = 3,
...
enum class EDataflowImageCombineResolutionOption {
    Lowest = 0,
    Highest = 1,
    UserDefined = 2,
...
enum class EDataflowImageResolution {
    Resolution16 = 16,
    Resolution32 = 32,
    Resolution64 = 64,
    Resolution128 = 128,
...
enum class EDataflowMathConstantsEnum {
...
enum class EDataflowSelectionType {
    Transform = 0,
    Vertices = 1,
    Faces = 2,
    Geometry = 3,
