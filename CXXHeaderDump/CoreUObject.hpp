...
struct FFieldCookedMetaDataStore
{
    ...
    TMap<class FFieldCookedMetaDataKey, class FFieldCookedMetaDataValue> SubFieldMetaData; // 0x0050 (size: 0x50)

}; // Size: 0xA0

struct FFieldCookedMetaDataValue
{
    TMap<class FName, class FString> MetaData;                                        // 0x0000 (size: 0x50)
...
class UVerseClass : public UClass
{
    ...
    TArray<class UClass*> DirectInterfaces;                                           // 0x0300 (size: 0x10)
    TArray<TFieldPath<FProperty>> PropertiesWrittenByInitCDO;                         // 0x0310 (size: 0x10)
    TMap<class FName, class FName> FunctionMangledNames;                              // 0x0320 (size: 0x50)
