...
{
    bool bSampleAdditionalTextures;                                                   // 0x0228 (size: 0x1)
    int32 AdditionalSlotIndex;                                                        // 0x022C (size: 0x4)
    FText SlotDisplayName;                                                            // 0x0230 (size: 0x10)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x0568 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0570 (size: 0x8)
    float PlayRate;                                                                   // 0x0578 (size: 0x4)
    uint8 bLooping;                                                                   // 0x057C (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x057C (size: 0x1)
    uint8 bPlaying;                                                                   // 0x057C (size: 0x1)
    float AccumulatedTime;                                                            // 0x0580 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x0584 (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x0588 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x0598 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x05A0 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x0568 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x0578 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x0568 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x0570 (size: 0x8)
...
{
    int32 MapWidth;                                                                   // 0x0568 (size: 0x4)
    int32 MapHeight;                                                                  // 0x056C (size: 0x4)
    int32 TileWidth;                                                                  // 0x0570 (size: 0x4)
    int32 TileHeight;                                                                 // 0x0574 (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x0578 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0580 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x0588 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x0598 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x05A8 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x05AC (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x05B0 (size: 0x8)
