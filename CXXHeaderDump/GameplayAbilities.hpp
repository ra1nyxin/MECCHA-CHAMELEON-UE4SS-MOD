...
struct FGameplayAbilityRepAnimMontage
{
    ...
    float PlayCount;                                                                  // 0x0020 (size: 0x4)
    uint8 NextSectionID;                                                              // 0x0024 (size: 0x1)
    uint8 PlayInstanceId;                                                             // 0x0025 (size: 0x1)
    uint8 bRepPosition;                                                               // 0x0026 (size: 0x1)
    uint8 IsStopped;                                                                  // 0x0026 (size: 0x1)
    uint8 SkipPositionCorrection;                                                     // 0x0026 (size: 0x1)
    uint8 bSkipPlayRate;                                                              // 0x0026 (size: 0x1)
    FPredictionKey PredictionKey;                                                     // 0x0028 (size: 0x10)
    uint8 SectionIdToPlay;                                                            // 0x0038 (size: 0x1)
...
{
    class UAbilitySystemComponent* Owner;                                             // 0x0330 (size: 0x8)
...
{
    FAbilityAsync_WaitGameplayTagQueryTriggered Triggered;                            // 0x0038 (size: 0x10)
...
class UAbilitySystemBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    void UnbindGameplayTagChangedEventWrapperForHandle(FGameplayTag Tag, FGameplayTagChangedEventWrapperSpecHandle Handle);
    void UnbindAllGameplayTagChangedEventWrappersForHandle(FGameplayTagChangedEventWrapperSpecHandle Handle);
    ...
    float Conv_ScalableFloatToFloat(const FScalableFloat& Input, float Level);
    double Conv_ScalableFloatToDouble(const FScalableFloat& Input, float Level);
    ...
    FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToGameplayTagChanged(class UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag Tag, FBindEventWrapperToGameplayTagChangedGameplayTagChangedEventWrapperDelegate GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, TEnumAsByte<EGameplayTagEventType::Type> TagListeningPolicy);
    FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToAnyOfGameplayTagsChanged(class UAbilitySystemComponent* AbilitySystemComponent, const TArray<FGameplayTag>& Tags, FBindEventWrapperToAnyOfGameplayTagsChangedGameplayTagChangedEventWrapperDelegate GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, TEnumAsByte<EGameplayTagEventType::Type> TagListeningPolicy);
    FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToAnyOfGameplayTagContainerChanged(class UAbilitySystemComponent* AbilitySystemComponent, const FGameplayTagContainer TagContainer, FBindEventWrapperToAnyOfGameplayTagContainerChangedGameplayTagChangedEventWrapperDelegate GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, TEnumAsByte<EGameplayTagEventType::Type> TagListeningPolicy);
...
class UAbilitySystemComponent : public UGameplayTasksComponent
{
    ...
    FGameplayAbilityRepAnimMontage RepAnimMontageInfo;                                // 0x0780 (size: 0x40)
    bool bCachedIsNetSimulated;                                                       // 0x07C0 (size: 0x1)
    bool bPendingMontageRep;                                                          // 0x07C1 (size: 0x1)
    FGameplayAbilityLocalAnimMontage LocalAnimMontageInfo;                            // 0x07C8 (size: 0x28)
    FActiveGameplayEffectsContainer ActiveGameplayEffects;                            // 0x0890 (size: 0x300)
    ...
    FMinimalReplicationTagCountMap MinimalReplicationTags;                            // 0x1040 (size: 0x68)
    TArray<class UAttributeSet*> SpawnedAttributes;                                   // 0x10A8 (size: 0x10)
    FMinimalReplicationTagCountMap ReplicatedLooseTags;                               // 0x10C8 (size: 0x68)
    FReplicatedPredictionKeyMap ReplicatedPredictionKeyMap;                           // 0x1138 (size: 0x118)
...
{
    FAbilityTask_ApplyRootMotionConstantForceOnFinish OnFinish;                       // 0x00C0 (size: 0x10)
    void ApplyRootMotionConstantForceDelegate();
    FVector WorldDirection;                                                           // 0x00D0 (size: 0x18)
    float Strength;                                                                   // 0x00E8 (size: 0x4)
...
{
    FAbilityTask_ApplyRootMotionJumpForceOnFinish OnFinish;                           // 0x00C0 (size: 0x10)
    void ApplyRootMotionJumpForceDelegate();
    FAbilityTask_ApplyRootMotionJumpForceOnLanded OnLanded;                           // 0x00D0 (size: 0x10)
    void ApplyRootMotionJumpForceDelegate();
    FRotator Rotation;                                                                // 0x00E0 (size: 0x18)
    float Distance;                                                                   // 0x00F8 (size: 0x4)
    float Height;                                                                     // 0x00FC (size: 0x4)
    float Duration;                                                                   // 0x0100 (size: 0x4)
    float MinimumLandedTriggerTime;                                                   // 0x0104 (size: 0x4)
    bool bFinishOnLanded;                                                             // 0x0108 (size: 0x1)
    class UCurveVector* PathOffsetCurve;                                              // 0x0110 (size: 0x8)
    class UCurveFloat* TimeMappingCurve;                                              // 0x0118 (size: 0x8)
...
{
    FAbilityTask_ApplyRootMotionMoveToActorForceOnFinished OnFinished;                // 0x00C0 (size: 0x10)
    ...
    class AActor* TargetActor;                                                        // 0x0108 (size: 0x8)
    class USceneComponent* TargetComponent;                                           // 0x0110 (size: 0x8)
    FVector TargetComponentRelativeLocation;                                          // 0x0118 (size: 0x18)
    FVector TargetLocationOffset;                                                     // 0x0130 (size: 0x18)
    ERootMotionMoveToActorTargetOffsetType OffsetAlignment;                           // 0x0148 (size: 0x1)
    float Duration;                                                                   // 0x014C (size: 0x4)
    bool bDisableDestinationReachedInterrupt;                                         // 0x0150 (size: 0x1)
    float ReachedDestinationDistance;                                                 // 0x0154 (size: 0x4)
    bool bSetNewMovementMode;                                                         // 0x0158 (size: 0x1)
    TEnumAsByte<EMovementMode> NewMovementMode;                                       // 0x0159 (size: 0x1)
    bool bRestrictSpeedToExpected;                                                    // 0x015A (size: 0x1)
    class UCurveVector* PathOffsetCurve;                                              // 0x0160 (size: 0x8)
    class UCurveFloat* TimeMappingCurve;                                              // 0x0168 (size: 0x8)
    class UCurveFloat* TargetLerpSpeedHorizontalCurve;                                // 0x0170 (size: 0x8)
    class UCurveFloat* TargetLerpSpeedVerticalCurve;                                  // 0x0178 (size: 0x8)
...
{
    FAbilityTask_ApplyRootMotionMoveToForceOnTimedOut OnTimedOut;                     // 0x00C0 (size: 0x10)
    void ApplyRootMotionMoveToForceDelegate();
    FAbilityTask_ApplyRootMotionMoveToForceOnTimedOutAndDestinationReached OnTimedOutAndDestinationReached; // 0x00D0 (size: 0x10)
    void ApplyRootMotionMoveToForceDelegate();
    FVector StartLocation;                                                            // 0x00E0 (size: 0x18)
    FVector TargetLocation;                                                           // 0x00F8 (size: 0x18)
    float Duration;                                                                   // 0x0110 (size: 0x4)
    bool bSetNewMovementMode;                                                         // 0x0114 (size: 0x1)
    TEnumAsByte<EMovementMode> NewMovementMode;                                       // 0x0115 (size: 0x1)
    bool bRestrictSpeedToExpected;                                                    // 0x0116 (size: 0x1)
...
{
    FAbilityTask_ApplyRootMotionRadialForceOnFinish OnFinish;                         // 0x00C0 (size: 0x10)
    void ApplyRootMotionRadialForceDelegate();
    FVector Location;                                                                 // 0x00D0 (size: 0x18)
    class AActor* LocationActor;                                                      // 0x00E8 (size: 0x8)
    float Strength;                                                                   // 0x00F0 (size: 0x4)
    float Duration;                                                                   // 0x00F4 (size: 0x4)
    float Radius;                                                                     // 0x00F8 (size: 0x4)
    bool bIsPush;                                                                     // 0x00FC (size: 0x1)
    bool bIsAdditive;                                                                 // 0x00FD (size: 0x1)
    bool bNoZForce;                                                                   // 0x00FE (size: 0x1)
    class UCurveFloat* StrengthDistanceFalloff;                                       // 0x0100 (size: 0x8)
    class UCurveFloat* StrengthOverTime;                                              // 0x0108 (size: 0x8)
    bool bUseFixedWorldDirection;                                                     // 0x0110 (size: 0x1)
    FRotator FixedWorldDirection;                                                     // 0x0118 (size: 0x18)
...
class UAbilityTask_ApplyRootMotion_Base : public UAbilityTask
{
    ...
    TWeakObjectPtr<class UCharacterMovementComponent> MovementComponent;              // 0x00AC (size: 0x8)
...
class UGameplayEffect : public UObject
{
    ...
    bool bFactorInStackCount;                                                         // 0x09EB (size: 0x1)
...
{
    FMovieSceneGameplayCueKey Cue;                                                    // 0x0120 (size: 0x90)
...
{
    FMovieSceneGameplayCueChannel Channel;                                            // 0x0120 (size: 0xF8)
