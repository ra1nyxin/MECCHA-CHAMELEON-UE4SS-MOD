#ifndef UE4SS_SDK_ABP_Penguin_HPP
#define UE4SS_SDK_ABP_Penguin_HPP
...
class UABP_Penguin_C : public UAnimInstance
{
    ...
    class ABP_AI_Base_C* Character;                                                   // 0x0A48 (size: 0x8)
