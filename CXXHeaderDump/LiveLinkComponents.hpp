...
{
    FLiveLinkSubjectRepresentation SubjectRepresentation;                             // 0x00B8 (size: 0x10)
    TMap<class TSubclassOf<ULiveLinkRole>, class ULiveLinkControllerBase*> ControllerMap; // 0x00C8 (size: 0x50)
    bool bUpdateInEditor;                                                             // 0x0118 (size: 0x1)
    FLiveLinkComponentControllerOnLiveLinkUpdated OnLiveLinkUpdated;                  // 0x0120 (size: 0x10)
    void LiveLinkTickDelegate(float DeltaTime);
    FLiveLinkComponentControllerOnControllerMapUpdatedDelegate OnControllerMapUpdatedDelegate; // 0x0130 (size: 0x10)
    void OnControllerMapUpdatedDelegate();
    bool bDisableEvaluateLiveLinkWhenSpawnable;                                       // 0x0140 (size: 0x1)
    bool bEvaluateLiveLink;                                                           // 0x0141 (size: 0x1)
    bool bUpdateInPreviewEditor;                                                      // 0x0142 (size: 0x1)
