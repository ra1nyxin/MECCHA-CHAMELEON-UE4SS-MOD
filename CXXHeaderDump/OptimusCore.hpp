...
{
    TArray<TSoftObjectPtr<UOptimusNode>> KernelToNode;                                // 0x00E0 (size: 0x10)
...
class UOptimusDeformer : public UMeshDeformer
{
    ...
    TMap<class TWeakObjectPtr<UComputeDataInterface>, class FOptimusDataInterfacePropertyOverrideInfo> DataInterfacePropertyOverrideMap; // 0x0068 (size: 0x50)
    TMap<class FOptimusValueIdentifier, class FOptimusValueDescription> ValueMap;     // 0x00B8 (size: 0x50)
    class UOptimusActionStack* ActionStack;                                           // 0x0108 (size: 0x8)
    EOptimusDeformerStatus Status;                                                    // 0x0110 (size: 0x4)
    TArray<class UOptimusNodeGraph*> Graphs;                                          // 0x0118 (size: 0x10)
...
class UOptimusDeformerDynamicInstanceManager : public UMeshDeformerInstance
{
    ...
    TMap<class FGuid, class UOptimusDeformerInstance*> GuidToInstanceMap;             // 0x0080 (size: 0x50)
...
class UOptimusNode_FunctionReference : public UOptimusNode
{
    ...
    TSoftObjectPtr<UOptimusFunctionNodeGraph> FunctionGraph;                          // 0x0148 (size: 0x28)
