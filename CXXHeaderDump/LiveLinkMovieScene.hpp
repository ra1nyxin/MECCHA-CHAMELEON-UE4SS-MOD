...
{
    FLiveLinkSubjectPreset SubjectPreset;                                             // 0x0108 (size: 0x38)
    TArray<bool> ChannelMask;                                                         // 0x0140 (size: 0x10)
    TArray<class UMovieSceneLiveLinkSubSection*> SubSections;                         // 0x0150 (size: 0x10)
    FName SubjectName;                                                                // 0x0170 (size: 0x8)
    FLiveLinkFrameData TemplateToPush;                                                // 0x0178 (size: 0x90)
    FLiveLinkRefSkeleton RefSkeleton;                                                 // 0x0208 (size: 0x20)
    TArray<FName> CurveNames;                                                         // 0x0228 (size: 0x10)
    TArray<FMovieSceneFloatChannel> PropertyFloatChannels;                            // 0x0238 (size: 0x10)
...
{
    TSubclassOf<class ULiveLinkRole> TrackRole;                                       // 0x0148 (size: 0x8)
