...
class UNNERuntimeORTDml_GPU : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x40

class UNNERuntimeORTDml_GPU_NPU : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x48

class UNNERuntimeORTDml_GPU_RDG : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x48

class UNNERuntimeORTDml_GPU_RDG_NPU : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x50

class UNNERuntimeORTDml_NPU : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x40

class UNNERuntimeORTDml_RDG : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x40

class UNNERuntimeORTDml_RDG_NPU : public UNNERuntimeORTDmlProxy
{
}; // Size: 0x48
