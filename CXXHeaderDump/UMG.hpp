...
class UListView : public UListViewBase
{
    ...
    TArray<class UObject*> ListItems;                                                 // 0x0AA8 (size: 0x10)
...
class UUserWidget : public UWidget
{
    ...
    TArray<class UUMGSequencePlayer*> ActiveSequencePlayers;                          // 0x0250 (size: 0x10)
    class UUMGSequenceTickManager* AnimationTickManager;                              // 0x0260 (size: 0x8)
    TArray<class UUMGSequencePlayer*> StoppedSequencePlayers;                         // 0x0268 (size: 0x10)
    TArray<FNamedSlotBinding> NamedSlotBindings;                                      // 0x02B8 (size: 0x10)
    TArray<class UUserWidgetExtension*> Extensions;                                   // 0x02C8 (size: 0x10)
