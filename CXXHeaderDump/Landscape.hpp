...
class ALandscapeProxy : public APartitionActor
{
    ...
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0478 (size: 0x10)
    ...
    TArray<class ULandscapeComponent*> LandscapeComponents;                           // 0x04A0 (size: 0x10)
    TArray<class ULandscapeHeightfieldCollisionComponent*> CollisionComponents;       // 0x04B0 (size: 0x10)
    TArray<class UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;       // 0x04C0 (size: 0x10)
    class ULandscapeNaniteComponent* NaniteComponent;                                 // 0x04D0 (size: 0x8)
    TArray<class ULandscapeNaniteComponent*> NaniteComponents;                        // 0x04D8 (size: 0x10)
    ...
    TMap<class FName, class FLandscapeTargetLayerSettings> TargetLayers;              // 0x0770 (size: 0x50)
...
{
    TSoftObjectPtr<ALandscape> LandscapeActorRef;                                     // 0x07C0 (size: 0x28)
...
class ULandscapeComponent : public UPrimitiveComponent
{
    ...
    TArray<class UMaterialInterface*> MobileMaterialInterfaces;                       // 0x06D0 (size: 0x10)
    TArray<class UTexture2D*> MobileWeightmapTextures;                                // 0x06E0 (size: 0x10)
...
class ULandscapeNaniteComponent : public UStaticMeshComponent
{
    ...
    TArray<class ULandscapeComponent*> SourceLandscapeComponents;                     // 0x0628 (size: 0x10)
...
class ULandscapeSubsystem : public UTickableWorldSubsystem
{
    ...
    TArray<class ALandscape*> LandscapeActors;                                        // 0x00E8 (size: 0x10)
    TArray<class ALandscapeProxy*> Proxies;                                           // 0x00F8 (size: 0x10)
