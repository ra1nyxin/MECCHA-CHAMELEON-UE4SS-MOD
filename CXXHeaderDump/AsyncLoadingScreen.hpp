...
struct FALoadingScreenSettings
{
    ...
    FBackgroundSettings Background;                                                   // 0x00F8 (size: 0x40)
    FTipSettings TipWidget;                                                           // 0x0138 (size: 0xC0)
    FLoadingWidgetSettings LoadingWidget;                                             // 0x0200 (size: 0x2B0)
    EAsyncLoadingScreenLayout Layout;                                                 // 0x04B0 (size: 0x1)
...
struct FBackgroundSettings
{
    ...
    float UpdateInterval;                                                             // 0x0010 (size: 0x4)
    TEnumAsByte<EStretch::Type> ImageStretch;                                         // 0x0014 (size: 0x1)
    FMargin Padding;                                                                  // 0x0018 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0028 (size: 0x10)
    bool bSetDisplayBackgroundManually;                                               // 0x0038 (size: 0x1)
...
struct FTipSettings
{
    ...
    float TipWrapAt;                                                                  // 0x00B8 (size: 0x4)
    bool bSetDisplayTipTextManually;                                                  // 0x00BC (size: 0x1)
...
{
    FALoadingScreenSettings StartupLoadingScreen;                                     // 0x0040 (size: 0x4C0)
    FALoadingScreenSettings DefaultLoadingScreen;                                     // 0x0500 (size: 0x4C0)
    FClassicLayoutSettings Classic;                                                   // 0x09C0 (size: 0xD0)
    FCenterLayoutSettings Center;                                                     // 0x0A90 (size: 0xD0)
    FLetterboxLayoutSettings Letterbox;                                               // 0x0B60 (size: 0x190)
    FSidebarLayoutSettings Sidebar;                                                   // 0x0CF0 (size: 0xE0)
    FDualSidebarLayoutSettings DualSidebar;                                           // 0x0DD0 (size: 0x190)
