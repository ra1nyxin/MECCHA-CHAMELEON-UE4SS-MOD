...
{
    FName Root;                                                                       // 0x0010 (size: 0x8)
    TArray<FPBIKEffector> Effectors;                                                  // 0x0018 (size: 0x10)
    TArray<int32> EffectorSolverIndices;                                              // 0x0028 (size: 0x10)
    TArray<FPBIKBoneSetting> BoneSettings;                                            // 0x0038 (size: 0x10)
    TArray<FName> ExcludedBones;                                                      // 0x0048 (size: 0x10)
    FPBIKSolverSettings Settings;                                                     // 0x0058 (size: 0x40)
    FPBIKDebug Debug;                                                                 // 0x0098 (size: 0x8)
    FPBIKWorkData WorkData;                                                           // 0x00A0 (size: 0x80)
