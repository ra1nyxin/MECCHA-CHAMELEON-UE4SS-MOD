...
struct FGroomDataflowSettings
{
    ...
    TArray<class USkeletalMesh*> SkeletalMeshes;                                      // 0x0018 (size: 0x10)
...
class UGroomAsset : public UObject
{
    ...
    TArray<class UAssetUserData*> AssetUserData;                                      // 0x0178 (size: 0x10)
...
{
    TArray<class UAssetUserData*> AssetUserData;                                      // 0x0048 (size: 0x10)
...
class UGroomComponent : public UMeshComponent
{
    ...
    TArray<class UNiagaraComponent*> NiagaraComponents;                               // 0x0588 (size: 0x10)
...
class UGroomCreateStrandsTexturesOptions : public UObject
{
    ...
    TArray<class UTexture2D*> GeneratedTextures;                                      // 0x0078 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> AnimationSections;                              // 0x0118 (size: 0x10)
