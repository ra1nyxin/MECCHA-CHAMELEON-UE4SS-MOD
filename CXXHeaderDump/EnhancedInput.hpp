...
struct FPlayerKeyMapping
{
    ...
    TSoftObjectPtr<UInputAction> AssociatedInputActionSoft;                           // 0x0080 (size: 0x28)
...
class UEnhancedInputLocalPlayerSubsystem : public ULocalPlayerSubsystem
{
    ...
    TMap<class UInputAction*, class FInjectedInput> ContinuouslyInjectedInputs;       // 0x01B8 (size: 0x50)
...
class UEnhancedInputUserSettings : public USaveGame
{
    ...
    TMap<class FGameplayTag, class UEnhancedPlayerMappableKeyProfile*> SavedKeyProfiles; // 0x0088 (size: 0x50)
    TMap<class FString, class UEnhancedPlayerMappableKeyProfile*> SavedKeyProfilesMap; // 0x00D8 (size: 0x50)
...
class UEnhancedPlayerInput : public UPlayerInput
{
    ...
    TMap<class UInputAction*, class FInputActionInstance> ActionInstanceData;         // 0x04E8 (size: 0x50)
    TMap<class UInputMappingContext*, class FAppliedInputContextData> AppliedInputContextData; // 0x0538 (size: 0x50)
    ...
    TMap<class FKey, class FVector> KeysPressedThisTick;                              // 0x0748 (size: 0x50)
    TMap<class UInputAction*, class FInjectedInputArray> InputsInjectedThisTick;      // 0x0798 (size: 0x50)
...
class UEnhancedPlayerMappableKeyProfile : public UObject
{
    ...
    TMap<class FName, class FKeyMappingRow> PlayerMappedKeys;                         // 0x0058 (size: 0x50)
