...
{
    TArray<class UObject*> Decorations;                                               // 0x0000 (size: 0x10)
...
struct FNavigationToolSaveState
{
    ...
    TMap<class FString, class FColor> ItemColorMap;                                   // 0x0088 (size: 0x50)
...
struct FNavigationToolSerializedTree
{
    ...
    TMap<class FNavigationToolSerializedItem, class FNavigationToolSerializedTreeNode> ItemTreeMap; // 0x0038 (size: 0x50)
...
{
    TMap<class FString, class ENavigationToolItemFlags> ViewItemFlags;                // 0x0000 (size: 0x50)
    TMap<class FName, class FNavigationToolViewColumnSaveState> ColumnsState;         // 0x0050 (size: 0x50)
...
class UMovieScene : public UMovieSceneDecorationContainerObject
{
    ...
    TMap<class FName, class FMovieSceneObjectBindingIDs> BindingGroups;               // 0x00A0 (size: 0x50)
    TArray<class UMovieSceneTrack*> Tracks;                                           // 0x00F0 (size: 0x10)
    ...
    TArray<class UMovieSceneGroupCondition*> GeneratedConditions;                     // 0x0158 (size: 0x10)
...
{
    TArray<TScriptInterface<IMovieSceneScalingDriver>> ScalingDrivers;                // 0x01C8 (size: 0x10)
    TMap<class FGuid, class FMovieSceneScalingAnchor> InitialAnchors;                 // 0x01D8 (size: 0x50)
    TMap<class FGuid, class FMovieSceneAnchorsScalingGroup> ScalingGroups;            // 0x0228 (size: 0x50)
...
{
    TArray<TScriptInterface<IMovieSceneTimeWarpSource>> Sources;                      // 0x0030 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> SectionArray;                                   // 0x0110 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> SectionArray;                                   // 0x0120 (size: 0x10)
