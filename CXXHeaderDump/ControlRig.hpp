...
struct FAnimNode_ControlRig : public FAnimNode_ControlRigBase
{
    ...
    TMap<class UClass*, class UControlRig*> ControlRigPerClass;                       // 0x0240 (size: 0x50)
    ...
    TMap<class FName, class FName> InputMapping;                                      // 0x0320 (size: 0x50)
    TMap<class FName, class FName> OutputMapping;                                     // 0x0370 (size: 0x50)
...
struct FModularRigModel
{
    ...
    TMap<class FRigHierarchyModulePath, class FName> PreviousModulePaths;             // 0x0098 (size: 0x50)
...
struct FModularRigModuleSettingsForClipboard
{
    ...
    TMap<class FString, class FString> Defaults;                                      // 0x0020 (size: 0x50)
    TMap<class FString, class FString> Overrides;                                     // 0x0070 (size: 0x50)
    TMap<class FName, class FString> Bindings;                                        // 0x00C0 (size: 0x50)

}; // Size: 0x110

struct FModularRigModuleSettingsSetForClipboard
{
    TMap<class FName, class FModularRigModuleSettingsForClipboard> Settings;          // 0x0000 (size: 0x50)
...
struct FRigModuleInstance
{
    ...
    TMap<class FName, class FRigVMExternalVariable> VariableBindings;                 // 0x0028 (size: 0x50)
...
struct FRigModuleReference
{
    ...
    TMap<class FRigElementKey, class FRigElementKey> Connections;                     // 0x0060 (size: 0x50)
    TMap<class FName, class FString> ConfigValues;                                    // 0x00B0 (size: 0x50)
    FControlRigOverrideContainer ConfigOverrides;                                     // 0x0100 (size: 0x158)
    TMap<class FName, class FString> Bindings;                                        // 0x0258 (size: 0x50)
...
{
    TArray<class UControlRigOverrideAsset*> OverrideAssets;                           // 0x02A8 (size: 0x10)
    ERigExecutionType ExecutionType;                                                  // 0x02B9 (size: 0x1)
    FRigHierarchySettings HierarchySettings;                                          // 0x02BC (size: 0x8)
    TMap<class FRigElementKey, class FRigControlElementCustomization> ControlCustomizations; // 0x02C8 (size: 0x50)
    class URigHierarchy* DynamicHierarchy;                                            // 0x0318 (size: 0x8)
    TArray<TSoftObjectPtr<UControlRigShapeLibrary>> ShapeLibraries;                   // 0x0320 (size: 0x10)
    TMap<class FString, class FString> ShapeLibraryNameMap;                           // 0x0330 (size: 0x50)
    ...
    TMap<class FName, class UDataAssetLink*> ExternalVariableDataAssetLinks;          // 0x07A0 (size: 0x50)
...
class UMovieSceneControlRigParameterSection : public UMovieSceneParameterSection
{
    ...
    TMap<class FName, class FChannelMapInfo> ControlChannelMap;                       // 0x0340 (size: 0x50)
...
{
    TMap<class FName, class TWeakObjectPtr<UMovieSceneSection>> SectionToKeyPerControl; // 0x0128 (size: 0x50)
    class UControlRig* ControlRig;                                                    // 0x01B0 (size: 0x8)
    class UMovieSceneSection* SectionToKey;                                           // 0x01B8 (size: 0x8)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x01C0 (size: 0x10)
    FName TrackName;                                                                  // 0x01D0 (size: 0x8)
    TMap<class FName, class FControlRotationOrder> ControlsRotationOrder;             // 0x01D8 (size: 0x50)
    int32 PriorityOrder;                                                              // 0x0228 (size: 0x4)
    FInstancedPropertyBag ControlRigSettingsOverrides;                                // 0x0230 (size: 0x10)
    TMap<class TWeakObjectPtr<UWorld>, class UControlRig*> GameWorldControlRigs;      // 0x0240 (size: 0x50)
