...
class UInterchangeStaticMeshLodDataNode : public UInterchangeFactoryBaseNode
{
    ...
    TMap<class FString, class FString> GetSphereCollisionMeshMap();
    ...
    TMap<class FString, class FString> GetConvexCollisionMeshMap();
    ...
    TMap<class FString, class FString> GetCapsuleCollisionMeshMap();
    ...
    TMap<class FString, class FString> GetBoxCollisionMeshMap();
