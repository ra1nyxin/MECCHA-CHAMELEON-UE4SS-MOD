...
class UInterchangeManager : public UObject
{
    ...
    TMap<class UClass*, class UClass*> RegisteredFactoryClasses;                      // 0x0288 (size: 0x50)
    TMap<class UClass*, class UInterchangeWriterBase*> RegisteredWriters;             // 0x02D8 (size: 0x50)
    TMap<class UClass*, class UInterchangeAssetImportDataConverterBase*> RegisteredConverters; // 0x0328 (size: 0x50)
    ...
    bool ReimportAsset(class UObject* ObjectToReimport, const FImportAssetParameters& ImportAssetParameters, TArray<class UObject*>& OutImportedObjects);
