...
{
    FDataflowSimulationTime SimulationTime;                                           // 0x0280 (size: 0xC)
    TArray<FDataflowSimulationProperty> PhysicsSolvers;                               // 0x0290 (size: 0x10)
...
{
    TArray<FDataflowSimulationProperty> SimulationProxies;                            // 0x0280 (size: 0x10)
    TArray<FDataflowSimulationProperty> FilteredProxies;                              // 0x0290 (size: 0x10)
    TArray<FString> SimulationGroups;                                                 // 0x02A0 (size: 0x10)
...
struct FGetPhysicsSolversDataflowNode : public FDataflowInvalidNode
{
    ...
    TArray<FString> SimulationGroups;                                                 // 0x0290 (size: 0x10)
