...
class UFoliageType : public UObject
{
    ...
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0498 (size: 0x10)
...
class UFoliageType_InstancedStaticMesh : public UFoliageType
{
    ...
    TArray<class UMaterialInterface*> OverrideMaterials;                              // 0x04B8 (size: 0x10)
    TArray<class UMaterialInterface*> NaniteOverrideMaterials;                        // 0x04C8 (size: 0x10)
