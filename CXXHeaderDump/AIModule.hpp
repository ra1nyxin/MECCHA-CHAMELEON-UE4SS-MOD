...
{
    TArray<class UAISenseConfig*> SensesConfig;                                       // 0x00B8 (size: 0x10)
...
class UAIPerceptionStimuliSourceComponent : public UActorComponent
{
    ...
    TArray<class TSubclassOf<UAISense>> RegisterAsSourceForSenses;                    // 0x00C0 (size: 0x10)
...
class UBlackboardComponent : public UActorComponent
{
    ...
    TArray<class UBlackboardKeyType*> KeyInstances;                                   // 0x00F0 (size: 0x10)
